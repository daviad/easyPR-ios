...
string mainpath="/Users/zhoushiwei/Dropbox/EasyPR/";
  // Create ERFilter objects with the 1st and 2nd stage default classifiers
  std::string pathMMmodel_1 =mainpath+ "resources/model/text/trained_classifierNM1.xml";
  std::string pathMMmodel_2 = mainpath+"resources/model/text/trained_classifierNM2.xml";
